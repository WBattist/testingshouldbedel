...
# This script is not CHATGPT-generated. The reasons there are so many comments is, I have dementia sometimes and forget what some things do 
...
echo "#                                  Makeshift VPS"
echo "#"
echo "#                           Copyright (C) 2023 - 2024, bb213"
echo "#"
echo "#"
echo "#######################################################################################"
echo ""
...
display_header() {
    echo -e "${BOLD_MAGENTA}            Makeshift VPS"
    echo -e "${BOLD_MAGENTA}               Free"
...
display_resources() {
    echo -e " INSTALLER OS -> ${BOLD_RED} $(cat /etc/os-release | grep "PRETTY_NAME" | cut -d'"' -f2) ${RESET_COLOR}"
    echo -e ""
